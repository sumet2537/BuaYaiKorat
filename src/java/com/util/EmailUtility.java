...
//        test
    ...
    public static void main(String[] args) throws MessagingException {
        Randorm randorm = new Randorm();
        String mss = randorm.getRandomCode();
        try {
            sendEmail("chakknrt123@gmail.com", "chakknrt111", "po_mal@hotmail.co.th", "Rge8", "รหัสรับเงินของคุณคือ = " + mss, null);
